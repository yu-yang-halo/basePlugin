...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_PluginsManager_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 54, 16)
    ...
    "PluginsManager\0publishPluginMsg\0\0"
    "TaihoPluginData\0data\0recMsgfromPlugin\0"
};
...
void PluginsManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->publishPluginMsg((*reinterpret_cast< TaihoPluginData(*)>(_a[1]))); break;
        case 1: _t->recMsgfromPlugin((*reinterpret_cast< TaihoPluginData(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (PluginsManager::*_t)(TaihoPluginData );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PluginsManager::publishPluginMsg)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject PluginsManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_PluginsManager.data,
      qt_meta_data_PluginsManager,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PluginsManager.stringdata))
...
// SIGNAL 0
void PluginsManager::publishPluginMsg(TaihoPluginData _t1)
{
